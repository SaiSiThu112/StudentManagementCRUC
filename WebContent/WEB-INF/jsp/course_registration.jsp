<%@page import="persistant.dto.ResponseStudentDto"%>
...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form action="CreateCourseController" method="post">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" id="id" name="id" value="COU<%= count %>">
						</div>
					</div>
