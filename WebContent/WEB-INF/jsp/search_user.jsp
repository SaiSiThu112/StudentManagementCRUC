	...
	<div class="container">
		<div class="sidenav">
			...
			<button class="dropdown-btn">
				...
				<a href="course_registration.jsp">Course Registration </a> <a
					href="student_registration.jsp">Student Registration </a> <a
					href="DisplayAttendController">Student Search </a>
			</div>
		...
		<div class="main_contents">
			<div id="sub_content">
				<form class="row g-3 mt-3 ms-2">
					...
					<div class="col-auto">
						<label for="inputPassword2" class="visually-hidden">User
							Name</label> <input type="text" class="form-control" id="inputPassword2" name="name"
							placeholder="User Name">
					</div>

					<div class="col-auto">
					
						<button type="submit" class="btn btn-primary mb-3" onclick="location.href = 'SearchUserController?id=${data.id}&name=${data.name}'">Search</button>
					</div>
					<div class="col-auto">
				...
				<table class="table table-striped" id="stduentTable">
					...
					<tbody>
					<c:forEach items="${sessionScope.searchresult}" var="data">
						<tr>
							<td>${data.userId}</td>
							<td>${data.userName}</td>
							...
							<td>
								<button type="button" class="btn btn-success  "
									onclick="location.href = 'update_user.jsp?id=${data.id}&name=${data.name}&email=${data.email}&password=${data.password}&confirmPassword=${data.password}'">Update</button>
							</td>
							<td><button type="submit" class="btn btn-secondary mb-3"
									data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="location.href='DeleteUserController?id=${data.id}'">Delete</button></td>
						</tr>
					</c:forEach>
					</tbody>
