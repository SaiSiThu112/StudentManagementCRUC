				...
				<form action="UpdateStudentController" method="post">
					...
					<div class="row mb-4">
						...
						<label for="studentID" class="col-md-2 col-form-label">Student
							ID</label>
						<div class="col-md-4">
							<input type="text" class="form-control" value="${param.id}"
								id="studentID" name="id" >
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							 <button type="submit" class="btn btn-danger " onclick="location.href='UpdateStudentServlet'">Update</button>
							<button type="submit" class="btn btn-secondary col-md-2"
								data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="location.href = 'DeleteStudentController?id=${param.id}'">
								Delete</button>
